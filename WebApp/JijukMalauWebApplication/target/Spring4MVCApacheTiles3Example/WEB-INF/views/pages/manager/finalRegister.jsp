    ...
    <div class="row justify-content-center">
      <div class="col-8 align-items-center">
        <div class="card">
          ...
          <div class="card-body">
            <form:form action="${pageContext.request.contextPath}/Register/register" method="POST" modelAttribute="register" name="my-form" onsubmit="return validform()">
            ...
            <div class="form-row col-auto justify-content-around">
              ...
              <div class="form-group col-12 col-md-4 row align-items-center">
                <a>Floor:</a>
                <form:input path="portalNumber" required="required" type="text" id="number" class="form-control" name="floor"/>
              </div>
              <div class="form-group col-12 col-md-4 row align-items-center">
                <a>Letter:</a>
                <form:input path="postalCode" required="required" type="text" id="postalCode" class="form-control" name="letter"/>
              </div>
		    </div>
