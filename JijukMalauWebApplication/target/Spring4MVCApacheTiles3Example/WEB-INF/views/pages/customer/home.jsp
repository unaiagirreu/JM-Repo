...
<div class="row">
	<c:forEach items="${items.itemList}" var="item" varStatus="status">
		<div class="card col-12 col-sm-6 col-md-4">
              <figure class="figure">
                <h3>${item.name}</h3>
                <img src="${pageContext.request.contextPath}/static/img/${item.name}.png" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
